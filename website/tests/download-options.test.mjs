...
test("download chooser pins both verified release tracks", async () => {
  ...
  assert.ok(app.includes("HORMACHUELOS-OPTIMIZED/releases/download/v1.0.2"));
  assert.ok(app.includes("Hormachuelos_Optimized_1.0.2_x64.msi"));
  assert.ok(app.includes("Hormachuelos_Optimized_1.0.2_x64-setup.exe"));
