...
const RELEASE_DOWNLOAD_BASE =
  "https://github.com/chmoralla-code/HORMACHUELOS/releases/download/v0.1.69";
...
const DESKTOP_DOWNLOADS = {
  ...
  windows: {
    msi: {
      ...
      href: `${RELEASE_DOWNLOAD_BASE}/Hormachuelos_0.1.69_x64_en-US.msi`,
      file: "Hormachuelos_0.1.69_x64_en-US.msi",
    },
    setup: {
      label: "Windows setup (EXE)",
      href: `${RELEASE_DOWNLOAD_BASE}/Hormachuelos_0.1.69_x64-setup.exe`,
      file: "Hormachuelos_0.1.69_x64-setup.exe",
    },
  },
};
