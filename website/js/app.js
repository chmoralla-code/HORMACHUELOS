...
const OPTIMIZED_RELEASE_DOWNLOAD_BASE =
  "https://github.com/chmoralla-code/HORMACHUELOS-OPTIMIZED/releases/download/v1.2.1-1";
...
const OPTIMIZED_DOWNLOADS = {
  ...
  windows: {
    msi: {
      ...
      href: `${OPTIMIZED_RELEASE_DOWNLOAD_BASE}/Hormachuelos_Optimized_1.2.1-1_x64.msi`,
      file: "Hormachuelos_Optimized_1.2.1-1_x64.msi",
    },
    setup: {
      label: "Optimized setup (EXE)",
      href: `${OPTIMIZED_RELEASE_DOWNLOAD_BASE}/Hormachuelos_Optimized_1.2.1-1_x64-setup.exe`,
      file: "Hormachuelos_Optimized_1.2.1-1_x64-setup.exe",
    },
  },
};
      ...
      <div class="download-editions" aria-label="Hormachuelos download options">
        ...
        <article class="card download-edition is-optimized" aria-labelledby="optimized-edition-title">
          ...
          <ul class="download-edition-points">
            ...
            <li>Preview Computer Use can observe, click, type, scroll, and debug in Ask mode</li>
